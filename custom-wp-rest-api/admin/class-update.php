...
class WCRA_Update{
  ...
  public  function WCRA_getPluginVersionFromRepository($slug,$getAllData=false) {
        ...
        return isset($plugins->$WCRA_PLUGIN_SLUG) ? $plugins->$WCRA_PLUGIN_SLUG->version : '0.0.0';
  }
  ...
  public function wcra_compare_version(){
    ...
    $current = isset($wcra_stable_version[WCRA_PLUGIN_TEXTDOMAIN]) ? $wcra_stable_version[WCRA_PLUGIN_TEXTDOMAIN]['current'] : $this->current_version;
    $stable = isset($wcra_stable_version[WCRA_PLUGIN_TEXTDOMAIN]) ? $wcra_stable_version[WCRA_PLUGIN_TEXTDOMAIN]['stable'] : '0.0.0';
